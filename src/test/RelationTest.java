...
public class RelationTest {
	 ...
	 * could test multiple tables
	 * data type
	 * no match
	 * do we keep duplicates columns <natural join -- no || equi join -- yes> That depends on us
	 * 
	 */
	public void testJoin() {
		...
		System.out.print(tr.getDesc().getSize());
	...
	/**
	 * other test we can write:
	 * rename should temperary
	 * what happens if we rename a col as some colname that already exist.
	 * rename to the same name/empty string
	 */
	...
	/**
	 * other test we can write:
	 * aggregate the empty relation with no tuples.
	 * what if operate avg on string
	 */
